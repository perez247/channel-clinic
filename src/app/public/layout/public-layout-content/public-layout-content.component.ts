...
@Component({
  selector: 'app-public-layout-content',
  templateUrl: './public-layout-content.component.html',
  styleUrls: ['./public-layout-content.component.scss']
})
export class PublicLayoutContentComponent implements OnInit {
